...
local function installFromGithub()
  ...
  if ver == "1" and confirm == "yes i do" then
   print("-- 1/4 CREATING DIRECTORIES --")
    ...
    os.execute("wget -f -q https://raw.githubusercontent.com/Tavyza/TherOS/main/sys/lib/centerText.lua /lib/centerText.lua")
    ...
    os.execute("wget -f -q https://raw.githubusercontent.com/Tavyza/TherOS/main/sys/systempuller.lua /boot/94_bootloader.lua")
